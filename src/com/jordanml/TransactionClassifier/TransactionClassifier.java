...
public class TransactionClassifier {
    ...
    public static void main(String[] args) {
        ...
        //Trial run discretization
        discretize(testData, testData.numAttributes()-1, "../data/disc_breast-cancer.arff");
        //Trial run data splitting
        ArrayList<Dataset> folds = splitData(testData, 10, "../data/test/testData");
        //Trial run reduct selection
    ...
    /**
     * Splits the given dataset across several folds. The data in each fold
     * is saved to path_fold_i.arff where i is the fold number and path is the 
     * given base path. 
     * 
    ...
    /**
     * Sets the class index of the given dataset and discretizes the data.
     * The resulting dataset is saved to the given path.
     * 
     * @param dataset
     * @param classIndex
     * @param path
